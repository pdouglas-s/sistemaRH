...
namespace sistemaRH.Controllers
{
    public class ValorHorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdValorHora,Preco")] ValorHora valorHora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdValorHora,Preco")] ValorHora valorHora)
        {
